...
%install
cd $HOME
mkdir -p rpmbuild/BUILDROOT/genesis-tam-1.0.0-1.x86_64
ls -al rpmbuild/BUILDROOT/genesis-tam-1.0.0-1.x86_64
pwd
mkdir rpmbuild/BUILDROOT/genesis-tam-1.0.0-1.x86_64/tmp
ls -al rpmbuild/BUILDROOT/genesis-tam-1.0.0-1.x86_64
cp rpmbuild/SOURCES/server-%{version}.tar.gz rpmbuild/BUILDROOT/genesis-tam-1.0.0-1.x86_64/tmp/
cp rpmbuild/SOURCES/web-%{version}.tar.gz rpmbuild/BUILDROOT/genesis-tam-1.0.0-1.x86_64/tmp/
cd rpmbuild/BUILDROOT/genesis-tam-1.0.0-1.x86_64/tmp/
ls
pwd
